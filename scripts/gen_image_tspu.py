...
slug = "tspu-belye-spiski-i-anomalnaya-marshrutizaciya-2026"
title = "ТСПУ, белые списки и аномальная маршрутизация: почему VPN перестал работать в России и что делать"
description = "Почему VPN перестал работать в России в 2026. ТСПУ, белые списки, аномальная маршрутизация, DPI V2, обход блокировок."
...
suitable for a VPN/security blog header showing network topology, deep packet inspection (DPI)
theme with digital barriers and a glowing tunnel breaking through firewall. Dark theme, 16:9, minimalist.
Abstract geometric grid, binary code streams, firewall wall with cracks, glowing light tunnel.
...
output_dir = "/opt/nemo-blog/public/articles/images"
