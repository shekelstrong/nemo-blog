...
**Как изолировать умные устройства от основной сети?**
Настройте VLAN на роутере: создайте отдельную подсеть для IoT (VLAN 10), настройте правила брандмауэра (между VLAN — deny all), подключите VPN только для IoT VLAN, основная сеть работает напрямую. Это изолирует взломанное IoT-устройство и защитит ваши ноутбуки и телефоны.