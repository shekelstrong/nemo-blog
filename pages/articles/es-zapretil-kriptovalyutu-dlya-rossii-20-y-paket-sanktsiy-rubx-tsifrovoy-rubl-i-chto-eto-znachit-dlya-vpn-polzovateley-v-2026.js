      ...
      <div className="max-w-2xl mx-auto">
        ...
        <article>
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-gray-800 leading-relaxed">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>2026-05-24:</strong> 20-й пакет санкций вступает в силу. Биржи и обменники усилят проверки. Некоторые VPN-провайдеры откажутся от крипты или ограничат платежи из России.</li>
